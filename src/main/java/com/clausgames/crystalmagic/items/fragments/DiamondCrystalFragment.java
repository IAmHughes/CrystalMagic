...
public class DiamondCrystalFragment extends OreCrystalFragment
{
    private Block blockPlant;
    private Block blockSoil;

    public DiamondCrystalFragment(String unlocalizedName, String textureName)
    {
        super(ModPlants.diamondCrystalPlant, ModPlants.diamondInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.diamondCrystalPlant;
        this.blockSoil = ModPlants.diamondInfusedStone;
