...
public class IronCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModPlants.ironCrystalPlant, ModPlants.ironInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.ironCrystalPlant;
        this.blockSoil = ModPlants.ironInfusedStone;
