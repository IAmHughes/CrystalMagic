...
public class QuartzCrystalFragment extends OreCrystalFragment
{
    private Block blockPlant;
    private Block blockSoil;

    public QuartzCrystalFragment(String unlocalizedName, String textureName)
    {
        super(ModPlants.quartzCrystalPlant, ModPlants.quartzInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.quartzCrystalPlant;
        this.blockSoil = ModPlants.quartzInfusedStone;
