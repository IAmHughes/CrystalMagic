...
public class RedstoneCrystalFragment extends OreCrystalFragment
{
    private Block blockPlant;
    private Block blockSoil;

    public RedstoneCrystalFragment(String unlocalizedName, String textureName)
    {
        super(ModPlants.redstoneCrystalPlant, ModPlants.redstoneInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.redstoneCrystalPlant;
        this.blockSoil = ModPlants.redstoneInfusedStone;
