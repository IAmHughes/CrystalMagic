...
public class ItemCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModPlants.crystalPlant, ModPlants.crystalInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.crystalPlant;
        this.blockSoil = ModPlants.crystalInfusedStone;
