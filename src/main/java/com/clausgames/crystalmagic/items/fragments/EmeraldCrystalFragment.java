...
public class EmeraldCrystalFragment extends OreCrystalFragment
{
    ...
    {
        super(ModPlants.emeraldCrystalPlant, ModPlants.emeraldInfusedStone); //blockPlant, blockSoil
        this.blockPlant = ModPlants.emeraldCrystalPlant;
        this.blockSoil = ModPlants.emeraldInfusedStone;
